...
extractDomain({
  domain: 'analytics',
  routeFile: path.join(BASE, 'modules/analytics/routes/analyticsRoutes.js'),
  serviceName: 'AnalyticsApplicationService',
  controllerName: 'AnalyticsController',
});
extractDomain({
  domain: 'backup',
  routeFile: path.join(BASE, 'modules/report/routes/backupRoutes.js'),
  serviceName: 'BackupApplicationService',
  controllerName: 'BackupController',
});
extractDomain({
  domain: 'monitoring',
  routeFile: path.join(BASE, 'modules/report/routes/monitoringRoutes.js'),
  serviceName: 'MonitoringApplicationService',
  controllerName: 'MonitoringController',
});
extractDomain({
  domain: 'systemLog',
  routeFile: path.join(BASE, 'modules/report/routes/systemLogRoutes.js'),
  serviceName: 'SystemLogApplicationService',
  controllerName: 'SystemLogController',
});
