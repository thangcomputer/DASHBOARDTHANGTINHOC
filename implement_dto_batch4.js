...
const domainsToMigrate = [
  { domain: 'cms', services: ['CmsApplicationService'] },
  { domain: 'blog', services: ['BlogApplicationService'] },
  { domain: 'chat', services: ['ChatApplicationService'] },
  { domain: 'feed', services: ['FeedApplicationService'] },
  { domain: 'ai', services: ['AiApplicationService'] },
  { domain: 'file', services: ['FileApplicationService'] },
