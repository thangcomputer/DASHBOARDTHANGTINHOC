...
const Get_id_full_detailQuery = require('./Get_id_full_detailQuery');
const Get_id_full_detailHandler = require('./Get_id_full_detailHandler');
queryRegistry.register('Get_id_full_detailQuery', new Get_id_full_detailHandler());
module.exports.Get_id_full_detailQuery = Get_id_full_detailQuery;
