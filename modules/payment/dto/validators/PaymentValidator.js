...
class PaymentValidator {
  ...
  static validateGet_payment_status_studentId(req) {
    ...
    if (!result.success) {
      ValidationMetrics.logFailure('payment', 'Get_payment_status_studentIdQuery', Date.now() - start, result.error.errors);
    ...
    ValidationMetrics.logSuccess('payment', 'Get_payment_status_studentIdQuery', Date.now() - start);
