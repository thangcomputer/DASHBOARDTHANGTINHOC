...
const students = `import React, { useState, useMemo, useEffect, useRef } from 'react';
...
fs.writeFileSync(path.join(HOOKS, 'useAdminStudents.jsx'), students, 'utf8');
console.log('wrote useAdminStudents.jsx');
