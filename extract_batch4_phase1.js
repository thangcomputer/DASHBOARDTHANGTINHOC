...
extractDomain({
  domain: 'cms_builder',
  routeFile: path.join(BASE, 'modules/cms/routes/builderRoutes.js'),
  serviceName: 'CmsApplicationService',
  controllerName: 'CmsController',
});
extractDomain({
  domain: 'cms_workflow',
  routeFile: path.join(BASE, 'modules/cms/routes/workflowRoutes.js'),
  serviceName: 'CmsApplicationService',
  controllerName: 'CmsController',
});
extractDomain({
  domain: 'blog',
  routeFile: path.join(BASE, 'modules/blog/routes/blogRoutes.js'),
  serviceName: 'BlogApplicationService',
