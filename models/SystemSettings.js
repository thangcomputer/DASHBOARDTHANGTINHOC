...
const systemSettingsSchema = new mongoose.Schema({
  ...
  teacherExamMinutesRaw: { type: mongoose.Schema.Types.Mixed },
  teacherEssayExamMinutesRaw: { type: mongoose.Schema.Types.Mixed },
  ...
  adminMfaEnabled: { type: Boolean, default: false },
