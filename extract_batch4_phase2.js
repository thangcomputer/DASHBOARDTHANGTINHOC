...
extractDomain({
  domain: 'chat',
  routeFile: path.join(BASE, 'modules/chat/routes/messageRoutes.js'),
  serviceName: 'ChatApplicationService',
  controllerName: 'ChatController',
});
extractDomain({
  domain: 'feed',
  routeFile: path.join(BASE, 'modules/feed/routes/feedRoutes.js'),
  serviceName: 'FeedApplicationService',
  controllerName: 'FeedController',
});
extractDomain({
  domain: 'ai',
  routeFile: path.join(BASE, 'modules/ai/routes/aiRoutes.js'),
  serviceName: 'AiApplicationService',
  controllerName: 'AiController',
});
extractDomain({
  domain: 'file',
  routeFile: path.join(BASE, 'modules/file/routes/fileRoutes.js'),
  serviceName: 'FileApplicationService',
  controllerName: 'FileController',
});
extractDomain({
  domain: 'support',
  routeFile: path.join(BASE, 'modules/support/support.routes.js'),
  serviceName: 'SupportApplicationService',
