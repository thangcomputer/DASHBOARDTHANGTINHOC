# Certificate DTO Review — Sprint 4.4 Batch 3
...
- **Mappers**: Generated `CertificateMapper` to translate payloads. MapperMetrics hooked for duration tracking.
...
Note: certificate domain currently contains no application services, but report is generated per ARB requirements.
