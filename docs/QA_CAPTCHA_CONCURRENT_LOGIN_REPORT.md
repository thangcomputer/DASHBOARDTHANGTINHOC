...
| AUTH-CONC-02a | Concurrent public login (36 HV+GV) | PASS | ok=36/36 wall=1707ms |
| AUTH-CONC-02b | Concurrent internal login (7 Admin+Staff) | WARN | ok=0/7 wall=15ms sample=400:Mã bảo vệ không đúng. Vui lòng thử lại. |
