...
extractDomain({
  domain: 'payment',
  routeFile: path.join(BASE, 'modules/payment/routes/webhookRoutes.js'),
  serviceName: 'PaymentApplicationService',
  controllerName: 'PaymentController',
});
extractDomain({
  domain: 'transaction',
  routeFile: path.join(BASE, 'modules/transaction/routes/transactionRoutes.js'),
  serviceName: 'TransactionApplicationService',
