...
const EvaluationStepper = ({ currentStep = 1, results = {}, practicalSubmitted = false, currentTeacher = null, compact = false }) => {
    ...
    return (
        <div className={`w-full bg-white rounded-2xl md:rounded-3xl ${pad} shadow-sm border border-slate-100 max-w-4xl mx-auto ${mb}`}>
            <p className={`text-xs font-black text-gray-400 uppercase tracking-widest text-center ${titleMb}`}>Quy trình đánh giá giảng viên</p>
                ...
                {steps.map((step, i) => (
                    <div key={step.id} className="relative z-10 flex flex-col items-center group">
                        ...
                        <div className={`${labelMt} text-center max-w-[5.5rem] sm:max-w-none`}>
                            <p className={`${compact ? 'text-xs' : 'text-xs'} font-black uppercase tracking-tight ${i + 1 === currentStep ? 'text-blue-700' : 'text-slate-900'}`}>{step.label}</p>
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-[#203DB5] rounded-[40px] overflow-hidden shadow-2xl relative group min-h-[320px] flex items-center">
                ...
                <div className="p-8 md:p-14 relative z-10 w-full lg:w-1/2">
                   <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 backdrop-blur-md px-4 py-2 rounded-full text-blue-100 text-xs font-black uppercase tracking-widest mb-6">
                      <Zap size={14} className="text-yellow-400" /> Xác thực chuyên môn
                   </div>
                   <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-white leading-[1.1] mb-4 tracking-tight">
            ...
            <div className="grid grid-cols-1 min-[576px]:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                 {[
                    ...
                    <div key={i} className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-slate-100 shadow-sm flex flex-col items-center text-center space-y-2 hover:shadow-md transition min-w-0">
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
                ...
                <div className="grid grid-cols-1 min-[576px]:grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className={`w-full ${grade.pass ? 'bg-[#008945]' : 'bg-red-700'} rounded-2xl md:rounded-3xl ${waitingAdmin ? 'p-3 md:p-4 mb-3' : 'p-4 md:p-5 mb-4 md:mb-6'} flex items-center justify-between shadow-lg relative overflow-hidden group`}>
            <div className={`flex items-center gap-3 md:gap-4 relative z-10 ${waitingAdmin ? 'min-w-0' : ''}`}>
                ...
                <div className="text-left min-w-0">
                   ...
                   <p className="text-white/70 text-xs md:text-xs font-bold leading-none uppercase tracking-widest">Điểm thi: {grade.total}/100</p>
                </div>
            </div>
                    ...
                    {!practicalSubmitted && !currentTeacher?.practicalFile ? (
                            ...
                            <React.Fragment>
                              ...
                              >
                                ...
                                <div className="w-full">
                                  ...
                                  <p className="text-slate-400 text-xs md:text-xs font-bold mt-1">Hỗ trợ: PDF, ZIP, MP4, DOCX, PPTX, XLSX (Tối đa 50MB)</p>
                                </div>
                        ...
                        <div className="space-y-4 animate-in fade-in zoom-in duration-500">
                            ...
                            <div className="bg-slate-50 rounded-2xl p-4 text-center border border-slate-100 space-y-1 group hover:bg-white transition-colors">
                                <p className="text-gray-400 font-bold text-xs cms-min-text-xs md:text-xs uppercase tracking-widest leading-none">Cần hỗ trợ gấp, vui lòng liên hệ:</p>
          ...
          <div className="relative grid grid-cols-1 gap-2.5 p-2.5 md:gap-3 md:p-3 lg:grid-cols-12 lg:items-center lg:gap-4">
            <div className="flex min-w-0 flex-col justify-center gap-2 lg:col-span-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="font-mono text-xs font-bold text-slate-400 md:text-xs">
                  {answeredCount}/{TOTAL}
                </span>
              </div>
              <div
            ...
            <div className="flex flex-col items-center text-center lg:col-span-4 lg:px-1">
              ...
              <p className="mt-1 text-xs font-black uppercase tracking-[0.35em] text-white/35 md:text-xs">SECURE EXAM</p>
          ...
          <main className="order-1 flex min-h-0 flex-col lg:order-2 lg:col-span-8 xl:col-span-9">
            <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-xl shadow-slate-200/50 backdrop-blur-sm">
              <div className="flex shrink-0 items-center justify-center border-b border-slate-100 bg-slate-50/80 py-2.5">
                <p className="text-xs font-bold uppercase tracking-[0.14em] text-slate-500 md:text-xs">
                  ...
                  <div className="flex h-full min-h-0 flex-col p-2.5 md:p-3 lg:p-4">
                    <div className="shrink-0 border-b border-slate-100 pb-2 md:pb-2.5">
                      <div className="flex items-center gap-2">
                        ...
                        {qCur.type === 'essay' ? (
                          <span className="rounded-lg bg-purple-100 px-2 py-0.5 text-xs font-black text-purple-700">TỰ LUẬN</span>
                        ) : (
                          <span className="rounded-lg bg-slate-100 px-2 py-0.5 text-xs font-black text-slate-600">TRẮC NGHIỆM</span>
                        )}
                        ...
                        <div className="space-y-3">
                          ...
                          {qCur.attachedFile && (
                            <div className="flex items-center justify-between rounded-xl border border-blue-100 bg-blue-50/80 p-3">
                              ...
                              <span className="text-xs font-bold text-blue-600">Tham khảo đề</span>
                            </div>
                          )}
                        </div>
                      ) : (
