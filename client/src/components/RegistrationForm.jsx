...
const RegistrationForm = ({ onNavigate }) => {
  ...
  useEffect(() => {
    ...
    if (!sessionRef.current) {
      const payAmount = formData.effectivePrice || formData.price;
  ...
  const handleNext = () => {
    ...
    if (!isValidVNPhone(formData.zalo)) {
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-5 space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-red-700">{(formData.effectivePrice || formData.price).toLocaleString('vi-VN')} VNĐ</span>
                  </div>
                </div>
            ...
            {step === 3 && (
              <div className="text-center space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-5 text-left space-y-2 text-sm">
                  ...
                  <div className="flex justify-between"><span className="text-gray-500">Học phí:</span><span className="font-bold text-red-700">{(formData.effectivePrice || formData.price).toLocaleString('vi-VN')} VNĐ</span></div>
