import { ArrowDown, ArrowUp, Eye, Loader2, Pencil, Power, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-3">
      <div className="flex justify-end">
        <button
          type="button"
          onClick={onDeleteAll}
          className="inline-flex min-h-11 items-center gap-2 px-4 rounded-xl text-sm font-bold text-red-600 border border-red-200 bg-white hover:bg-red-50"
        >
              ...
              <tr key={q._id || q.id} className="border-t border-slate-100">
                ...
                <td className="px-4 py-3">
                  <div className="flex justify-end gap-1">
                    ...
                    <button type="button" aria-label="Xóa câu hỏi" onClick={() => onDelete(q)} className="w-10 h-10 rounded-xl hover:bg-red-50 text-red-600">
                      <Trash2 size={15} />
                    </button>
                  </div>
                </td>
