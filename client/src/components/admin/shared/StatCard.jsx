    ...
    <div className="cms-kpi-card group">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2">
          <p className="text-xs sm:text-sm font-bold text-slate-600 truncate leading-tight">
            {label}
          </p>
          {trend != null && (
            <span
        ...
        {sub && (
          <p className="text-xs text-slate-500 mt-1 leading-snug line-clamp-1 font-medium">
            {sub}
          </p>
        )}
      </div>
